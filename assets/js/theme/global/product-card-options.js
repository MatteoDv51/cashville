        ...
        this.$cardImg.on('load', () => {
            this.$cardFigure.removeClass('loading');
                ...
                {                            
                   ...
                   // console.log('entity:'+attributesData[index2].node['entityId']);
                        ...
                        if (typeof attributesData.in_stock_attributes === 'object' || attributesData[index2].node['inventory']['isInStock'])
                        {
                            ...
                            if(attributesData[index2].node['productOptions'].edges.length>0)
                            {
                                ...
                                {                                                
                                    ...
                                    if(swatch_val[index3].node['displayName']=='Color' && swatch_val[index3].node['displayStyle']=='Swatch')
                                    {                           
                                        ...
                                        {          
                                            ...
                                            if(img_url==null)
                                                ...
                                                $swatch_html+="<li class='options_slide'  data-swatch-count='"+cnt+"'><a class='productCard-colorSwatch' href='#' data-product-swatch-id='"+id+"' data-product-swatch-value='"+col_id+"' data-product-option-value='"+col_id+"' data-product-option-id='"+id+"' data-product-option-label='"+label+"'><img src='"+img_url+"' alt='"+label+"' title='"+label+"'></a></li>";                                                        
            ...
            this.$cardFigure.addClass('loading');
                for (let index7 = 0; index7 < rec_data.length; index7++) 
                   ...
                   // console.log(lab);
                    ...
                    /* 
                    for (let index5 = 0; index5 < swatch_cnt; index5++)
                     {
                            var vals_len=swatch_val[index5].node['values'].edges.length;
                            for (let index6 = 0; index6< vals_len; index6++) 
                            {
                                var chck_id=swatch_val[index5].node['values'].edges[index6].node['entityId'];                               
                                if(chck_id==val)
                                {
                                    if(size>0 && swatch_img.length>vals_len)
                                    {
                                        var newindex=(index6+1)*size;
                                        var temp=size;
                                        console.log(swatch_img);
                                        swatch_img=swatch_img[newindex-temp].node['defaultImage'].url;       
                                        console.log(newindex-temp);
                                    }
                                    else
                                        swatch_img=swatch_img[index6].node['defaultImage'].url;                                    
                                    console.log(swatch_img);                                 
                                }
                            }                        
                    } */
                ...
                if (swatch_img!=null) {
                    ...
                    //$activecard.attr('src', img);
                    //$activecard.attr('srcset', img);
                    //this.$cardImg.attr('src', img);
                    //this.$cardImg.attr('srcset', img);
...
function check() {
    ...
    //console.log(context.showSwatch);
